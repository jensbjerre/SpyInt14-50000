xmlport 50090 SpyXmlCreateJournalLine
{
                            ...
                            if genJournalLine.FindSet() then begin
                                ...
                                repeat
                                    ...
                                    IF DBDefDim.FindSet() then begin
                                        repeat
                                            DB2.SETFILTER("Dimension Code", DBDefDim."Dimension Code");
                                            IF not DB2.FindSet() then begin
                                                DB.Reset();
                                                DB.Init();
                                                DB."Entry No." := EntryNo;
                                                EntryNo := EntryNo + 1;
    ...
    var
        ...
        DB2: Record "Dimension Buffer" temporary;
